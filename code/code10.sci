//
// Project  Metthod to aprox. dif. Three Example
// File     aproxDifThree.sci
...
//
	...
	//Ache a derivada primeira de f(x) = – 0,1x4 – 0,15x3 – 0,5x2 – 0,25x + 1,2;
	//Faça o cálculo em x = 0.5, usando o passo de cálculo de de 1 e e divida progressivamente o tamanho do passo por um fator 2;
	//Construa um gráfico do erro total x h.
